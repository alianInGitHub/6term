...
public class AddStudentFrame extends AddObjectFrame {
    ...
    public AddStudentFrame(AbstractProcessor processor, Point parentLocation) {
    ...
    protected void submitChanges() {
        ...
        try {
            Student student = processor.createStudent(firstName, lastName, address, phoneNumber);
            processor.addStudent(student, groupName);
