...
public class MainFrame extends JFrame {
    ...
    private void initialize() {
        ...
        setResizable(false);
        setLocation(400, 300);
        loadDataFromFile("src/Department.xml");
    }
    ...
    private void openSaveFileFrame() {
        ...
        if (retval == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                if (Objects.equals(getExtension(file), "txt")) {
                    processor.saveToFile(file.getPath());
                } else if (Objects.equals(getExtension(file), "xml")) {
                    XMLCreator.writeIntoXMLFile(file.getPath(), processor.getDepartment());
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
